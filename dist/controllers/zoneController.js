...
module.exports = {
    ...
    updateZoneInfo: async (req, res) => {
        ...
        try {
            await db.zones.updateOne({ zoneName }, {
                $set: {
                    zoneName: zoneName,
                    rate: rate
                }
    ...
    addZoneHandler: async (req, res) => {
        ...
        try {
            await db.zones.updateOne({ zoneName: zoneName }, {
                $push: {
                    zoneHandlers: {
    ...
    deleteZoneHandler: async (req, res) => {
        ...
        try {
            await db.zones.updateOne({ zoneName: zoneName }, { $pull: { zoneHandlers: { id: handler } } });
            return res.json({
                success: true,
    ...
    updateZoneHandlerAvailability: async (req, res) => {
        ...
        try {
            await db.zones.updateMany({ zoneHandlers: { id: user._id, available: !available } }, { $set: { "zoneHandlers.$": { id: user._id, available: available } } });
            return res.json({
                success: true,
