...
exports.getHandlersLocationController =
  exports.pickupDeliveryController =
  exports.getDeliveryByIdController =
  exports.getDeliveryIdsController =
  exports.getPartnerDeliveryHistoryController =
  exports.getUserDeliveryHistoryController =
  exports.getAllDeliveriesController =
  exports.trackDeliveryController =
  exports.encryptDeliveryDetailsController =
  exports.updateDeliveryController =
  exports.createDeliveryController =
  exports.calculateDeliveryCostController =
    void 0
...
const calculateDeliveryCostController = async (req, res) => {
  try {
    ...
    const delivery_cost = await (0,
    deliveryCostService_1.calculateDeliveryCostService)(deliveryData)
    return res.json({
      success: true,
      delivery_cost,
  ...
  try {
    ...
    if (newDelivery) {
      const assignedDriver =
        await scheduling_1.default.assignDriverToDeliveryService(
...
exports.getPartnerDeliveryHistoryController =
  getPartnerDeliveryHistoryController
